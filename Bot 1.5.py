...
async def handle_choice(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if choice == 'formatacao':
        ...
        response = "SSDS: \n\n"\
                   "SSD SATA: Utiliza a interface SATA, comumente encontrado em laptops e desktops. Valor: R$250\n"\
                   "SSD PCIe/NVMe: Utiliza a interface PCIe, oferecendo velocidades de transferência de dados mais rápidas em comparação com o SATA. É comum em sistemas mais avançados. Valor: R$350\n"\
                   "M.2 SSD: Um formato compacto que utiliza a interface SATA ou PCIe/NVMe. Muito utilizado em laptops e placas-mãe modernas. Valor: R$300\n"\
                   "SAS SSD: Projetado para ambientes corporativos e servidores, utiliza a interface SAS (Serial Attached SCSI). Valor: R$400"
        ...
        response = "HDS: \n\n"\
                   "HDD SATA: Utiliza a interface SATA, sendo uma opção mais comum em sistemas mais antigos ou de armazenamento em massa. Valor: R$150\n"\
                   "HDD SAS: Projetado para ambientes empresariais, utiliza a interface SAS e oferece maior confiabilidade e desempenho do que os HDDs SATA convencionais. Valor: R$250\n"\
                   "HDD SSHD (Solid State Hybrid Drive): Combina tecnologia de HDD com uma pequena quantidade de armazenamento SSD para melhorar o desempenho geral, armazenando dados frequentemente acessados no SSD. Valor: R$200\n"\
                   "HDD de 2,5 polegadas e 3,5 polegadas: Refere-se ao tamanho físico do disco rígido. HDDs de 2,5 polegadas são comuns em laptops, enquanto HDDs de 3,5 polegadas são mais utilizados em desktops. Valor: R$180"
        ...
        # resposta para a escolha de SSD SATA
        response = "Você selecionou SSD SATA. O valor é de R$250. Aqui está a chave PIX para você realizar o pagamento: [Chave PIX]"
